  ...
  return (
    <form
      ...
      onSubmit={async (e: any) => {
        ...
        setMessages((currentMessages: Array<{ id: string; display: React.ReactNode }>) => [
          ...currentMessages,
          {
            id: nanoid(),
        ...
        setMessages((currentMessages: Array<{ id: string; display: React.ReactNode }>) => [...currentMessages, responseMessage])
      }}
    >
